...
export class loanRequestComponent implements OnInit {
  ...
  // LoanPurpose:  Array<any>=['', '', '', '', ''];
  LoanPurposes: LoanPurpose[] = [
    { value: 'PersonalLoan', viewValue: 'Personal Loan' },
    { value: 'HomeLoan', viewValue: 'Home Loan' },
    { value: 'CarLoan', viewValue: 'Car Loan' },
    { value: 'Two-wheelerLoan', viewValue: 'Two-wheeler Loan' },
    { value: 'Education Loan', viewValue: 'Education Loan' }
  ];

  customerTypes: CustomerType[] = [
    { value: 'GeneralCustomer', viewValue: 'General Customer' },
    { value: 'GovtInstitution', viewValue: 'Govt. Institution' },
    { value: 'Firm', viewValue: 'Firm' },
    { value: 'PublicLtdCompany', viewValue: 'Public Ltd. Company'},
    { value: 'widow', viewValue: 'widow' },
    { value: 'PrivateLtdCompany', viewValue: 'Private Ltd.Company' },
    { value: 'Bank', viewValue: 'Bank' },
    { value: 'SeniorCitizen', viewValue: 'Senior Citizen' },
    { value: 'Society', viewValue: 'Society' },
    { value: 'Staff', viewValue: 'Staff' },
    { value: 'Student', viewValue: 'Student' },
    { value: 'Trust', viewValue: 'Trust' },
    { value: 'Women', viewValue: 'Women ' },
    { value: 'Zero Balance Account', viewValue: 'Zero Balance Account ' },
    { value: 'Handicap', viewValue: 'Handicap' }, 
    { value: 'InvestmentCustomer', viewValue: 'Investment Customer ' },
    { value: 'HUFGROUP', viewValue: 'HUF GROUP ' },
    { value: 'Staff Relative', viewValue: 'Staff Relative' }
