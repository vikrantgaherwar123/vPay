...
export class WhyUsComponent implements OnInit {
  ...
  constructor(private router: Router, private dialog: MatDialog, private dataStorage: DataStorage, private errorHandler: ErrorHandler,
    private spinner: Spinner, private common: Common) { }
